    ...
    switch (movie) {
      case 'Movie 1':
        movieDetails = '<h2>Harry Potter and the Deathly Hallows: Part II</h2>' +
                       '<img src="/src/img/movie_posters/2011.jpeg" alt="Movie 1" width="300">' +
      ...
      case 'Movie 2':
        movieDetails = '<h2>The Avengers</h2>' +
                       '<img src="/src/img/movie_posters/2012.jpg" alt="Movie 2" width="300">' +
        ...
        movieDetails = '<h2>Frozen</h2>' +
                       '<img src="/src/img/movie_posters/2013.jpeg" alt="Movie 3" width="300">' +
        ...
        movieDetails = '<h2>Transformers: Age of Extinction</h2>' +
                       '<img src="/src/img/movie_posters/2014.jpeg" alt="Movie 4" width="300">' +
        ...
        movieDetails = '<h2>Star Wars Ep. VII: The Force Awakens</h2>' +
                       '<img src="/src/img/movie_posters/2015.jpeg" alt="Movie 5" width="300">' +
        ...
        movieDetails = '<h2>Captain America: Civil War</h2>' +
                       '<img src="/src/img/movie_posters/2016.jpg" alt="Movie 6" width="300">' +
        ...
        movieDetails = '<h2>Star Wars Ep. VIII: The Last Jedi</h2>' +
                       '<img src="/src/img/movie_posters/2017.jpg" alt="Movie 7" width="300">' +
        ...
        movieDetails = '<h2>Avengers: Infinity War</h2>' +
                       '<img src="/src/img/movie_posters/2018.jpeg" alt="Movie 8" width="300">' +
        ...
        movieDetails = '<h2>Avengers: Endgame</h2>' +
                       '<img src="/src/img/movie_posters/2019.jpeg" alt="Movie 9" width="300">' +
        ...
        movieDetails = '<h2>Kimetsu no Yaiba: Mugen Ressha-Hen</h2>' +
                       '<img src="/src/img/movie_posters/2020.jpeg" alt="Movie 10" width="300">' +
        ...
        movieDetails = '<h2>Spider-Man: No Way Home</h2>' +
                       '<img src="/src/img/movie_posters/2021.jpg" alt="Movie 11" width="300">' +
        ...
        movieDetails = '<h2>Avatar: The Way of Water</h2>' +
                       '<img src="/src/img/movie_posters/2022.jpg" alt="Movie 12" width="300">' +
